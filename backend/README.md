...
## Project Structure
    ...
    ├── wmata_binder_replac_44801  # Django project configurations
...
1. Clone this repo and `cd wmata_binder_replac_44801`
...
2. Clone this repo and `cd wmata_binder_replac_44801`
