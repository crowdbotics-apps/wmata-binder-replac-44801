"""
Django settings for wmata_binder_replac_44801 project.
...
ROOT_URLCONF = 'wmata_binder_replac_44801.urls'
...
WSGI_APPLICATION = 'wmata_binder_replac_44801.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wmata_binder_replac_44801 API",
    "DESCRIPTION": "API documentation for wmata_binder_replac_44801 App",
    "VERSION": "v1",
}
